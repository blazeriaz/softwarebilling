...
class MY_Form_validation extends CI_Form_validation {
	...
	*/
	...
	function file_allowed_type($file,$type)
	{
		...
		$ext_groups['image']			= array('jpg', 'jpeg', 'png', 'bmp', 'jpe', 'pjpeg', 'svg', 'svgz', 'tif', 'tiff', 'ico', 'xpng', 'psd');
	...
	function custom_select($val){
		if(empty($val)){
			$this->CI->form_validation->set_message('custom_select', ucfirst($this->CI->lang->line('custom_select')));
			return FALSE;
		}
		return TRUE;
	}
