                          ...
                          <tbody>
                             <?php if($total_rows > 0 ) {
                             		...
                             		foreach ($users as $key=>$res) 
                             		{
										...
										<a href="<?php echo SITE_URL().SITE_ADMIN_URI;?>/users/delete/<?php echo $res['id'];?>" title = "Delete"><span class="icon glyphicon glyphicon-trash"></span><span class="title">Delete</span></a> 
