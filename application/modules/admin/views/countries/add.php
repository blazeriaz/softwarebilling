					...
					<div class="card custom-card">
						<div class="card-header">
                   		...
                   		<div class="card-body">
							...
							<?php } ?>
                    		<?php  $attributes = array('class' => 'form-horizontal','id' => 'countries_form', 'autocomplete'=>'off' );				
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-4">
									<?php echo form_input('country_code',set_value('country_code'),'placeholder= "Country Code" class="form-control" id="country_code"'); 
