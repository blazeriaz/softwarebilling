				...
				<div class="card custom-card">
					<div class="card-header">
						<div class="card-title">
							<div class="title"><?php echo 'Edit Purchase'  ?></div>
						</div>
                    ...
                    <div class="card-body">
						...
						echo form_open_multipart('', $attributes); ?>
							...
							<div class="col-sm-12">
                                ...
                                <div class="col-sm-4">
									<?php 
									if($this->input->post('seller_name')){ $seller_name = $this->input->post('seller_name'); }else if($purchase['seller_name']){ $seller_name = $purchase['seller_name']; }else{ $seller_name =''; }
									echo form_input('seller_name',$seller_name,'placeholder= "Seller Name" class="form-control" id="seller_name"'); 
							...
							<div class="col-sm-12">
                                ...
                                <div class="col-sm-4">
									<?php 
									if($this->input->post('seller_gst')){ $seller_gst = $this->input->post('seller_gst'); }else if($purchase['seller_gst']){ $seller_gst = $purchase['seller_gst']; }else{ $seller_gst =''; }
									echo form_input('seller_gst',$seller_gst,'placeholder= "Seller GST No" class="form-control" id="seller_gst"'); 
                                ...
                                <div class="col-sm-4">
									<?php
									if($this->input->post('invoice_no')){ $invoice_no = $this->input->post('invoice_no'); }else if($purchase['invoice_no']){ $invoice_no = $purchase['invoice_no']; }else{ $invoice_no =''; }
									echo form_input('invoice_no',$invoice_no,'placeholder= "Invoice No" class="form-control" id="invoice_no"'); 
							...
							<div class="col-sm-12">
                                ...
                                <div class="col-sm-4">
									<?php
									if($this->input->post('commodity_code')){ $commodity_code = $this->input->post('commodity_code'); }else if($purchase['commodity_code']){ $commodity_code = $purchase['commodity_code']; }else{ $commodity_code =''; }									
									echo form_input('commodity_code',$commodity_code,'placeholder= "Commodity Code" class="form-control" id="commodity_code"'); 
							...
							<?php echo form_label('HSN Code <span class="required">*</span>','hsn_code',array('class'=>'col-sm-2 control-label')); ?>
                                <div class="col-sm-4">
									<?php
									if($this->input->post('hsn_code')){ $hsn_code = $this->input->post('hsn_code'); }else if($purchase['hsn_code']){ $hsn_code = $purchase['hsn_code']; }else{ $hsn_code =''; }																		
									echo form_input('hsn_code',$hsn_code,'placeholder= "HSN Code" class="form-control" id="hsn_code"'); 
							...
							<div class="col-sm-12">
                                ...
                                <div class="col-sm-4">
									<?php
									if($this->input->post('tonage')){ $tonage = $this->input->post('tonage'); }else if($purchase['tonage']){ $tonage = $purchase['tonage']; }else{ $tonage =''; }																		
									echo form_input('tonage',$tonage,'placeholder= "Tonage" class="form-control" id="tonage"'); 
                                ...
                                <div class="col-sm-4">
									<?php
									if($this->input->post('sales_value')){ $sales_value = $this->input->post('sales_value'); }else if($purchase['sales_value']){ $sales_value = $purchase['sales_value']; }else{ $sales_value =''; }																		
									echo form_input('sales_value',$sales_value,'placeholder= "Sales Value" class="form-control" id="sales_value"'); 
							...
							<div class="col-sm-12">
                                ...
                                <div class="col-sm-4">
									<?php
									if($this->input->post('invoice_date')){ $invoice_date = $this->input->post('invoice_date'); }else if($purchase['invoice_date']){ $invoice_date = date('d-m-Y',strtotime($purchase['invoice_date'])); }else{ $invoice_date =''; }
									echo form_input('invoice_date',$invoice_date,'placeholder= "Invoice Date" class="form-control" id="o_search_from_date" readonly'); 
                                ...
                                <div class="col-sm-4">
									<?php
								if($this->input->post('rate_of_tax')){ $rate_of_tax = $this->input->post('rate_of_tax'); }else if($purchase['rate_of_tax']){ $rate_of_tax = $purchase['rate_of_tax']; }else{ $rate_of_tax =''; }																											
									echo form_input('rate_of_tax',$rate_of_tax,'placeholder= "Rate of Tax" class="form-control" id="rate_of_tax"'); 
							...
							<div class="col-sm-12">
                                ...
                                <div class="col-sm-4">
									<?php
									if($this->input->post('sgst')){ $sgst = $this->input->post('sgst'); }else if($purchase['sgst']){ $sgst = $purchase['sgst']; }else{ $sgst =''; }																											
									echo form_input('sgst',$sgst,'placeholder= "SGST Amount" class="form-control" id="sgst"'); 
                                ...
                                <div class="col-sm-4">
									<?php
									if($this->input->post('cgst')){ $cgst = $this->input->post('cgst'); }else if($purchase['cgst']){ $cgst = $purchase['cgst']; }else{ $cgst =''; }																											
									echo form_input('cgst',$cgst,'placeholder= "CGST Amount" class="form-control" id="sgst"'); 
							...
							<div class="col-sm-12">
                                ...
                                <div class="col-sm-4">
									<?php
									if($this->input->post('total_value')){ $total_value = $this->input->post('total_value'); }else if($purchase['total_value']){ $total_value = $purchase['total_value']; }else{ $total_value =''; }																											
									echo form_input('total_value',$total_value,'placeholder= "Total Amount" class="form-control" id="sgst"'); 
                                ...
                                <div class="col-sm-4">
									<?php									
									if($this->input->post('tcs_tax_percent')){ $tcs_tax_percent = $this->input->post('tcs_tax_percent'); }else if($purchase['tcs_tax_percent']){ $tcs_tax_percent = $purchase['tcs_tax_percent']; }else{ $tcs_tax_percent =''; }																											
									echo form_input('tcs_tax_percent',$tcs_tax_percent,'placeholder= "Tcs Percentage" class="form-control" id="tcs_tax_percent"'); 
							...
							<div class="col-sm-12">
                                ...
                                <div class="col-sm-4">
									<?php
									if($this->input->post('tcs_amount')){ $tcs_amount = $this->input->post('tcs_amount'); }else if($purchase['tcs_amount']){ $tcs_amount = $purchase['tcs_amount']; }else{ $tcs_amount =''; }																											
									echo form_input('tcs_amount',$tcs_amount,'placeholder= "Tcs Amount" class="form-control" id="tcs_amount"'); 
