							...
							<div class="blocks block_1">
								<div class="list list_1">
									<div class="col-md-12 col-sm-3 col-xs-3">
										...
										<input name='diag_title_1' id="diag_title_1" class="diag_title" type="text" value="" />
									</div>											
									<div class="col-md-6 col-sm-3 col-xs-3 his_fin_1">
										<h4>History Finding(s)</h4>
										<input name="his_fin_1_1" id="his_find_1_1" class="his_fin" type="text" value="" />
										<input name="his_fin_1_2" id="his_find_1_2" class="his_fin" type="text" value="" />
										<input name="his_fin_1_3" id="his_find_1_3" class="his_fin" type="text" value="" />
									</div>											
									<div class="col-md-6 col-sm-3 col-xs-3 phy_ex_1">
										<h4>Physical Exam Finding(s)</h4>
										<input name="phy_ex_1_1" id="phy_ex_1_1" class="phy_ex" type="text" value="" />
										<input name="phy_ex_1_2" id="phy_ex_1_2" class="phy_ex" type="text" value="" />
										<input name="phy_ex_1_3" id="phy_ex_1_3" class="phy_ex" type="text" value="" />
									</div>
								</div>										
							</div>
						</div>
							...
							<div class="blocks block_2">
								<div class="list list_2">
									<div class="col-md-12 col-sm-3 col-xs-3">
										...
										<input name='diag_title_2' id="diag_title_2" class="diag_title" type="text" value="" />
									</div>											
									<div class="col-md-6 col-sm-3 col-xs-3 his_fin_2">
										<h4>History Finding(s)</h4>
										<input name="his_fin_2_1" id="his_find_2_1" class="his_fin" type="text" value="" />
										<input name="his_fin_2_2" id="his_find_2_2" class="his_fin" type="text" value="" />
										<input name="his_fin_2_3" id="his_find_2_3" class="his_fin" type="text" value="" />
									</div>											
									<div class="col-md-6 col-sm-3 col-xs-3 phy_ex_2">
										<h4>Physical Exam Finding(s)</h4>
										<input name="phy_ex_2_1" id="phy_ex_2_1" class="phy_ex" type="text" value="" />
										<input name="phy_ex_2_2" id="phy_ex_2_2" class="phy_ex" type="text" value="" />
										<input name="phy_ex_2_3" id="phy_ex_2_3" class="phy_ex" type="text" value="" />
									</div>
								</div>										
							</div>
						</div>
							...
							<div class="blocks block_3">
								<div class="list list_3">
									<div class="col-md-12 col-sm-3 col-xs-3">
										...
										<input name='diag_title_3' id="diag_title_3" class="diag_title" type="text" value="" />
									</div>											
									<div class="col-md-6 col-sm-3 col-xs-3 his_fin_3">
										<h4>History Finding(s)</h4>
										<input name="his_fin_3_1" id="his_find_3_1" class="his_fin" type="text" value="" />
										<input name="his_fin_3_2" id="his_find_3_2" class="his_fin" type="text" value="" />
										<input name="his_fin_3_3" id="his_find_3_3" class="his_fin" type="text" value="" />
									</div>											
									<div class="col-md-6 col-sm-3 col-xs-3 phy_ex_3">
										<h4>Physical Exam Finding(s)</h4>
										<input name="phy_ex_3_1" id="phy_ex_3_1" class="phy_ex" type="text" value="" />
										<input name="phy_ex_3_2" id="phy_ex_3_2" class="phy_ex" type="text" value="" />
										<input name="phy_ex_3_3" id="phy_ex_3_3" class="phy_ex" type="text" value="" />
									</div>
								</div>										
							</div>
						</div>
							...
							<div class="blocks">
								<div class="list">
									<div class="col-md-12 col-sm-3 col-xs-3 addDiag-div">
										...
										<input name="diag_stud_1" id="diag_stud_1" class="diag_stud" type="text" value="" />
										<input name="diag_stud_2" id="diag_stud_2" class="diag_stud" type="text" value="" />
										<input name="diag_stud_3" id="diag_stud_3" class="diag_stud" type="text" value="" />
									</div>	
								</div>										
							</div>
							<div class="list-updown col-md-12 col-sm-3 col-xs-3">
...
$(document).ready(function() {
	...
	$('#text_hc,#text_pe,.diag_title,.his_fin,.phy_ex').prop('disabled', true);
	
	$( ".patient-blocks" ).click(function() {
		$(".login-btn").click()[0];
	});
