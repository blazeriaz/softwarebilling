...
(function ($) {
    ...
    function minutesSeconds($this, opts) {
        var id = $this.attr('id');
        if((opts.onTimeType == 2) && (window['minutes_MS' + id] <= opts.onTimeVal) && (window['seconds_MS' + id] == 0)){
            onTime($this, opts);
        }
    ...
    //Function for calling the given function name when particular time reached
    function onTime($this, opts) {
        if (opts.onTime != null) {
            if ($.isFunction(opts.onTime) == true) {
                opts.onTime.apply($this, []);
            }
        }
    }
    ...
    $.fn.countdowntimer.defaults = {
        ...
        onTime: null,
        onTimeVal: 0,
        onTimeType: 0, // 1 - seconds , 2 - minutes , 3- hours , 4 - days
        expiryUrl: null,
